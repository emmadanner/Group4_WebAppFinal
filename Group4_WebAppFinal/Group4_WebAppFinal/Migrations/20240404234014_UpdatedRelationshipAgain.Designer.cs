...
namespace Group4_WebAppFinal.Migrations
{
    ...
    [Migration("20240404234014_UpdatedRelationshipAgain")]
    partial class UpdatedRelationshipAgain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Group4_WebAppFinal.Controllers.Entities.Team", b =>
                {
                    ...
                    b.Property<int>("PokemonNamePokemonId")
                        .HasColumnType("int");

                    b.HasKey("TeamId");

                    b.HasIndex("PokemonNamePokemonId");
            ...
            modelBuilder.Entity("Group4_WebAppFinal.Controllers.Entities.Team", b =>
                {
                    b.HasOne("Group4_WebAppFinal.Controllers.Entities.Pokemon", "PokemonName")
                        .WithMany("Team")
                        .HasForeignKey("PokemonNamePokemonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PokemonName");
                });
